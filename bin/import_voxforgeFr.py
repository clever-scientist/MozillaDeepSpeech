...
def _download_and_preprocess_data(data_dir):
    ...
    voxforge_url = 'http://www.repository.voxforge1.org/downloads/fr/Trunk/Audio/Main/16kHz_16bit/'
        ...
        if path.isdir(path.join(promts_file[:-11], "wav")):
            with codecs.open(promts_file, 'r', 'utf-8') as f:
                for line in f:
                    ...
                    sentence = re.sub("[^a-z'’àâçéèêëïîôöùüûœæ1234567890]", " ", sentence.strip().lower())
